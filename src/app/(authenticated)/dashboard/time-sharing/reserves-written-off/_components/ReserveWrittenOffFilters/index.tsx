...
type ReserveWrittenOffFiltersProps = {
  filters: FiltersProps;
  setFilters: React.Dispatch<React.SetStateAction<FiltersProps>>;
  handleSearch: () => void;
};

const FILTERS_STORAGE_KEY = "ts_reservwithpoints_filters";
const ALL_FILTERS_VISIBLE = "ts_reservwithpoints_filters_all_visible";
const thereIsLocalStorage = typeof window != "undefined" && window.localStorage;

export default function ReserveWrittenOffFilters({
  filters,
  setFilters,
  handleSearch,
}: ReserveWrittenOffFiltersProps) {
