...
import ListAppointmentsAdm from "../_components/ListAppointmentsAdm";
...
export default function AppointmentsAdmAdmViewPage() {
    ...
    <>
           ...
           <Grid container spacing={2}>
             ...
             <Grid xs={12} md={4}>
               <Box sx={{ mb: 1 }}>
                 ...
                 >
                   <BusinessIcon sx={{ marginLeft: 1 }} fontSize="small" />
                   Dados Pessoais
                 </Typography>
                 ...
                 <Stack spacing={1}>
                   <Box sx={{ display: "flex", alignItems: "center", gap: 1, flexWrap: 'wrap', ml: 2 }}>
                     ...
                     <Chip 
                       label={owner?.enterpriseName || 'N/A'}
                       variant="outlined"
                       size="small"
                       sx={{ 
                         fontWeight: 'bold',
                   ...
                   <Box sx={{ display: "flex", alignItems: "center", gap: 1, flexWrap: 'wrap', ml: 2 }}>
                     ...
                     <Typography fontWeight="bold" sx={{ fontSize: '0.875rem' }}>
                       {owner?.clientName || owner?.clientName || 'N/A'}
                     </Typography>
                   </Box>
                 </Stack>
               </Box>
               ...
               <Box sx={{ mb: 1 }}>
                 ...
                 <Stack spacing={1}>
                   <Box sx={{ display: "flex", alignItems: "center", gap: 1, flexWrap: 'wrap' }}>
                     ...
                     <Chip 
                       label={owner?.fractionName || owner?.quotaId || 'N/A'}
                       variant="filled"
                       size="small"
                       sx={{ 
                   ...
                   <Box sx={{ display: "flex", alignItems: "center", gap: 1, flexWrap: 'wrap' }}>
                     ...
                     <Chip 
                       label={owner?.propertyNumber || 'N/A'}
                       variant="outlined"
                       size="small"
                 ...
                 <Stack spacing={1}>
                   <Box sx={{ display: "flex", alignItems: "center", gap: 1, flexWrap: 'wrap' }}>
                     ...
                     <Box sx={{ display: 'flex', gap: 0.5, flexWrap: 'wrap' }}>
                       <Chip 
                         label={owner?.contractNumber || 'N/A'}
                         variant="filled"
                         size="small"
                         sx={{ 
                       ...
                       />
                       <Chip 
                         label={owner?.quotaGroupNome || 'N/A'}
                         variant="outlined"
                         size="small"
                         sx={{ 
      ...
      <Box sx={{ ml: { xs: 0, md: 2 }, mr: { xs: 0, md: 1 }, mt: 2 }}>
        ...
        {isLoading ? (
          ...
          <Stack spacing={2}>
            <Box sx={{ ml: { xs: 0, md: 2 }, mr: { xs: 0, md: 1 } }}>
              <ListAppointmentsAdm appointments={appointments} />
            </Box>
            <Box
              display={"flex"}
              gap={2}
